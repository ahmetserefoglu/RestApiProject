          ...
          <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-8">
                        <h3 class="mb-0">{{ __('Araç  Düzenle') }}</h3>
                    </div>
            ...
            <div class="card-body">
                <form method="post" action="{{ route('aracplaka.update', ['id' => $aracplaka->id]) }}" autocomplete="off">
                    {{ csrf_field() }}
                    ...
                    <div class="pl-lg-4">
                         ...
                         <div class="form-group{{ $errors->has('arac_sahibi') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" name="ariza_konu" id="input-name" class="form-control form-control-alternative{{ $errors->has('arac_sahibi') ? ' is-invalid' : '' }}"  placeholder="{{ __('Arac Sahibi') }}" value="{{ old('ariza_konu', $aracplaka->arac_sahibi) }}" required autofocus>
                        </div>
