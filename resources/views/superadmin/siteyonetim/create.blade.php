    ...
    <div class="row">
        ...
        <section class="col-lg-6 connectedSortable">
          <div class="card">
            ...
            <div class="card-body">
                <form method="post" action="{{ route('siteyonetim.store') }}" autocomplete="off">
                  {{ csrf_field() }}
                  ...
                  <div class="pl-lg-4">
                    <div class="form-group{{ $errors->has('blok_adi') ? ' has-danger' : '' }}">
                        ...
                        <input type="text" name="blok_adi" id="input-name" class="form-control form-control-alternative{{ $errors->has('blok_adi') ? ' is-invalid' : '' }}" placeholder="{{ __('Blok Adı') }}"  required autofocus>
                    </div>
                    <div class="form-group{{ $errors->has('daire_sayisi') ? ' has-danger' : '' }}">
                        ...
                        <input type="number" name="daire_sayisi" id="input-name" class="form-control form-control-alternative{{ $errors->has('daire_sayisi') ? ' is-invalid' : '' }}" placeholder="{{ __('Daire Sayısı') }}" required autofocus>
                    </div>
