            ...
            <div class="col-12 col-sm-6 col-md-4">
              <div class="info-box">
                <span class="info-box-icon bg-info elevation-1">
                  <a href="/arizabildirim"><i class="fas fa-cog"></i></a>
                </span>

                <div class="info-box-content">
                  <span class="info-box-text">Arıza Bildirimi</span>
            ...
            <div class="col-12 col-sm-6 col-md-4">
              <div class="info-box mb-3">
                <span class="info-box-icon bg-danger elevation-1">
                  <a href="/degerlendirme"><i class="far fa-star"></i></a>
                </span>

                <div class="info-box-content">
                  <span class="info-box-text">Değerlendirmeler</span>
            ...
            <div class="col-12 col-sm-6 col-md-4">
              <div class="info-box mb-3">
                <span class="info-box-icon bg-warning elevation-1">
                  <a href="/kullanicilar"><i class="fas fa-users"></i></a>
                </span>
            ...
            <div class="col-12 col-sm-6 col-md-4">
              <div class="info-box mb-3">
                <span class="info-box-icon bg-success elevation-1">
                  <a href="/siparis"><i class="fas fa-shopping-cart"></i></a>
                </span>
          ...
          <div class="col-md-4 col-sm-6 col-12">
            <div class="info-box">
              <span class="info-box-icon bg-info">
                <a href="/mesajlar"><i class="far fa-envelope"></i></a>
              </span>
          ...
          <div class="col-md-4 col-sm-6 col-12">
            <div class="info-box">
              <span class="info-box-icon bg-warning">
                <a href="/aracplaka"><i class="far fa-copy"></i></a>
              </span>

              <div class="info-box-content">
                <span class="info-box-text">Araç Plaka Kayıt</span>
                <span class="info-box-number"></span>
              </div>
              <!-- /.info-box-content -->
            </div>
