    ...
    <div class="row">
        ...
        <section class="col-lg-6 connectedSortable">
          <div class="card">
            ...
            <div class="card-body">
                <form method="post" action="{{ route('site.store') }}" autocomplete="off">
                  {{ csrf_field() }}
                  ...
                  <div class="pl-lg-4">
                    <div class="form-group{{ $errors->has('site_adi') ? ' has-danger' : '' }}">
                        ...
                        <input type="text" name="site_adi" id="input-name" class="form-control form-control-alternative{{ $errors->has('site_adi') ? ' is-invalid' : '' }}" placeholder="{{ __('Site Adı') }}"  required autofocus>
                    </div>
                    <div class="form-group{{ $errors->has('site_yonetici_adi') ? ' has-danger' : '' }}">
                        ...
                        <input type="text" name="site_yonetici_adi" id="input-name" class="form-control form-control-alternative{{ $errors->has('site_yonetici_adi') ? ' is-invalid' : '' }}" placeholder="{{ __('Site Yönetici Adi') }}" required autofocus>
                    </div>
                    <div class="form-group{{ $errors->has('aidat') ? ' has-danger' : '' }}">
                        <label class="form-control-label" for="input-name">{{ __('Aidat') }}</label>
                        <input type="number" step="0.01" name="aidat" id="input-name" class="form-control form-control-alternative{{ $errors->has('aidat') ? ' is-invalid' : '' }}" placeholder="{{ __('Aidat') }}" required autofocus>
                    </div>
