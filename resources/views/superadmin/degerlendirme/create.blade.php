          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">{{ __('Yeni Değerlendirme') }}</h3>
                </div>
            ...
            <div class="card-body">
              <form method="post" action="{{ route('degerlendirme.store') }}" autocomplete="off">
                {{ csrf_field() }}
                ...
                <div class="pl-lg-4">
                  ...
                  <div class="form-group{{ $errors->has('degerlendirme_derece') ? ' has-danger' : '' }}">
                    ...
                    <div class="rating">
                      <input id="input-1" name="degerlendirme_derece" class="rating rating-loading" data-min="0" data-max="5" data-step="1" value="" data-size="xs">
                    </div>
                  </div>
